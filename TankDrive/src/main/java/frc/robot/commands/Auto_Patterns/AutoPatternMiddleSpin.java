...
public class AutoPatternMiddleSpin extends SequentialCommandGroup {
  /** Creates a new AutoPatternOne. */
  public AutoPatternMiddleSpin(DriveTrainSubsystem drive, ShooterSubsystemPID shooter, FeederSubsystem feeder, VisualFeedbackSubsystem vfs) {
