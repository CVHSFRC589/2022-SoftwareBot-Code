...
public class AutoPatternLimelight extends SequentialCommandGroup {
  /** Creates a new AutoPatternOne. */
  public AutoPatternLimelight(DriveTrainSubsystem drive, ShooterSubsystemPID shooter, FeederSubsystem feeder, LimeLightAiming lime, VisualFeedbackSubsystem vfs) {
